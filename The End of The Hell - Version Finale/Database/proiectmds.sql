...
CREATE TABLE `album` (
  ...
  `albyear` int(4) NOT NULL,
  `albgenre` varchar(45) NOT NULL
...
INSERT INTO `album` (`albid`, `albtitle`, `albyear`, `albgenre`) VALUES
(1, 'Sweet but Psycho', 2018, 'pop'),
(2, 'bad guy', 2019, 'funk'),
(3, 'Map of the Soul: 7', 2019, 'kpop'),
(4, 'Kill This Love', 2019, 'kpop'),
(5, 'Wings', 2016, 'kpop'),
(6, 'Not Today', 2017, 'kpop'),
(7, 'Obsession', 2019, 'kpop'),
(8, 'Natural', 2018, 'rock-alternative'),
(9, 'Love Shot', 2018, 'kpop'),
(10, 'River', 2016, 'rock'),
(11, 'Love Yourself', 2018, 'kpop'),
(12, 'Sanctify', 2018, 'dance'),
(13, 'Tear You Apart', 2006, 'rock'),
(14, 'Lunisolar', 2019, 'pop'),
(15, 'Everything Black', 2017, 'electronic'),
(16, 'Rin ~Daughters of Mnemosyne~ OST', 2008, 'rock, jpop'),
(17, 'League of Legends OST', 2012, 'pop, electronic, rock, ballad, ost'),
(18, 'Enjoy The Silence', 2015, 'ballad'),
(19, 'Fallen', 2003, 'rock, ballad'),
(20, 'Origin', 2000, 'rock'),
(21, 'Divisions', 2019, 'rock'),
(22, 'Life in Cartoon Motion', 2007, 'pop'),
(23, 'Waiting On the Sky to Change', 2020, 'rock'),
(24, 'Puddle Of Mudd', 2001, 'pop'),
(25, 'Perfect Words', 2002, 'pop'),
(26, 'Dreaming Out Loud', 2006, 'pop'),
(27, 'All The Little Lights', 2012, 'pop');
